...
public class FrmProducto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnEditar.setToolTipText("");
        popupMenu.add(mnEditar);

        mnEliminar.setText("Eliminar");
        mnEliminar.setToolTipText("");
        ...
        jLabel11.setText("AGREGAR / EDITAR PRODUCTOS");

        jLabel12.setFont(new java.awt.Font("Segoe UI", 2, 10)); // NOI18N
        jLabel12.setText("*Campo deshabilitado.");
        ...
        tblProducto.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nombre", "Descripción", "Precio", "Stock", "Marca", "Categoria"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                DTOProducto objeto = new DTOProducto();
                DAOProducto dao = new DAOProducto();
                FrmProducto frm = new FrmProducto();
                CtrlProducto  ct = new CtrlProducto(objeto, dao, frm);
    ...
    public javax.swing.JMenuItem mnEliminar;
